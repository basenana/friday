...
- The content returned by the tool may be deleted at any time. To prevent the loss of conclusions, any thoughts generated after the tool results should be output.
